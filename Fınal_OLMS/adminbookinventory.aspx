                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Current Stock" Enabled="true" TextMode="Number" BackColor="#CCCCCC"></asp:TextBox>

                                </div>
                            </div>

                            <div class="col-md-4">
                                <label>Alınmış Kitap Sayısı</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Issued Books" Enabled="true" TextMode="Number"  BackColor="#CCCCCC"></asp:TextBox>
